...
import org.xtext.example.cpl.formatting2.CPLFormatter;
import org.xtext.example.cpl.generator.CPLGenerator;
import org.xtext.example.cpl.parser.antlr.CPLAntlrTokenFileProvider;
import org.xtext.example.cpl.parser.antlr.CPLParser;
import org.xtext.example.cpl.parser.antlr.internal.InternalCPLLexer;
import org.xtext.example.cpl.scoping.CPLScopeProvider;
import org.xtext.example.cpl.serializer.CPLSemanticSequencer;
import org.xtext.example.cpl.serializer.CPLSyntacticSequencer;
import org.xtext.example.cpl.services.CPLGrammarAccess;
import org.xtext.example.cpl.validation.CPLConfigurableIssueCodesProvider;
import org.xtext.example.cpl.validation.CPLValidator;

/**
 * Manual modifications go to {@link CPLRuntimeModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractCPLRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/xtext/example/cpl/CPL.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.xtext.example.cpl.CPL");
	}
	...
	public Class<? extends ISemanticSequencer> bindISemanticSequencer() {
		return CPLSemanticSequencer.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISyntacticSequencer> bindISyntacticSequencer() {
		return CPLSyntacticSequencer.class;
	}
	...
	public Class<? extends IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return CPLAntlrTokenFileProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Class<? extends Lexer> bindLexer() {
		return InternalCPLLexer.class;
	}
	...
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Provider<? extends InternalCPLLexer> provideInternalCPLLexer() {
		return LexerProvider.create(InternalCPLLexer.class);
	}
	...
	public void configureRuntimeLexer(Binder binder) {
		binder.bind(Lexer.class)
			...
			.to(InternalCPLLexer.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	@SingletonBinding(eager=true)
	public Class<? extends CPLValidator> bindCPLValidator() {
		return CPLValidator.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends ConfigurableIssueCodesProvider> bindConfigurableIssueCodesProvider() {
		return CPLConfigurableIssueCodesProvider.class;
	}
