...
entryRuleRelationCP returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getRelationCPRule()); }
	iv_ruleRelationCP=ruleRelationCP
	{ $current=$iv_ruleRelationCP.current; }
	EOF;

// Rule RelationCP
ruleRelationCP returns [EObject current=null]
@init {
	enterRule();
}
@after {
