...
public class CPLSemanticSequencer extends CompleteOCLSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == BaseCSPackage.eINSTANCE)
			...
			case BaseCSPackage.IMPORT_CS:
				if (rule == grammarAccess.getImportCPRule()) {
					sequence_ImportCP(context, (ImportCS) semanticObject); 
					return; 
				}
				else if (rule == grammarAccess.getImportCSRule()) {
		...
		else if (epackage == CPLPackage.eINSTANCE)
			switch (semanticObject.eClass().getClassifierID()) {
	...
	/**
	 * Contexts:
	 *     RelationCP returns RelationCP
	 *
	 * Constraint:
	 *     ownedConditions+=ConditionCS+
	 */
	protected void sequence_RelationCP(ISerializationContext context, RelationCP semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
