...
public class CPLResourceDescriptionStrategy extends DefaultResourceDescriptionStrategy {
  ...
  public void createEObjectDescriptionForModel(final TopLevelCP model, final IAcceptor<IEObjectDescription> acceptor) {
    ...
    userData.put(CPLResourceDescriptionStrategy.INCLUDES, IterableExtensions.join(uris, ","));
