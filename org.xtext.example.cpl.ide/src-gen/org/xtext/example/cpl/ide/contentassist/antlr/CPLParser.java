 ...
 */
package org.xtext.example.cpl.ide.contentassist.antlr;
...
import org.xtext.example.cpl.ide.contentassist.antlr.internal.InternalCPLParser;
import org.xtext.example.cpl.services.CPLGrammarAccess;

public class CPLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(CPLGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CPLGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getImportCPAccess().getAlternatives_0(), "rule__ImportCP__Alternatives_0");
			builder.put(grammarAccess.getRelationCPAccess().getAlternatives_2_0(), "rule__RelationCP__Alternatives_2_0");
			...
			builder.put(grammarAccess.getTopLevelCPAccess().getOwnedContextsAssignment_4_3(), "rule__TopLevelCP__OwnedContextsAssignment_4_3");
			builder.put(grammarAccess.getTopLevelCPAccess().getOwnedRelationAssignment_5(), "rule__TopLevelCP__OwnedRelationAssignment_5");
			builder.put(grammarAccess.getTopLevelCPAccess().getOwnedMessageAssignment_6(), "rule__TopLevelCP__OwnedMessageAssignment_6");
	...
	@Override
	protected InternalCPLParser createParser() {
		InternalCPLParser result = new InternalCPLParser(null);
